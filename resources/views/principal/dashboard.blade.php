                ...
                <div class="col-sm-7 mt-6">
                    <div class="card-body">
                        ...
                        <p class="welcome-text mb-6">
                            Welcome to your school dashboard, where you can manage students, track their progress, and communicate with their parents efficiently. This platform provides you with the tools to support and lead your school.
                        </p>
                    </div>
                </div>
    ...
    <div class="col-12 col-md-4 mb-4">
        <a href="{{route('student.list')}}" class="text-decoration-none">
            <div class="card dashboard-card h-100">
                ...
                <h5 class="dashboard-card-title">Manage Students</h5>
            </div>
        </a>
    </div>

    <div class="col-12 col-md-4 mb-4">
        <a href="{{ route('principal.student.progress') }}" class="text-decoration-none">
            <div class="card dashboard-card h-100">
                <div class="card-icon-container">
                    <img src="../assets/img/icons/unicons/pa.jpeg" alt="Manage Parents" class="card-icon">
                </div>
                <h5 class="dashboard-card-title">Students Progress</h5>
            </div>
        </a>
    </div>

    <div class="col-12 col-md-4 mb-4">
        <a href="{{ route('school.parents') }}" class="text-decoration-none">
            <div class="card dashboard-card h-100">
                <div class="card-icon-container">
                    <img src="../assets/img/icons/unicons/pa.jpeg" alt="Manage Parents" class="card-icon">
                </div>
                <h5 class="dashboard-card-title">View Parents</h5>
            </div>
        </a>
    </div>
