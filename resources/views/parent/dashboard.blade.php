                ...
                <div class="col-sm-7 mt-6">
                    <div class="card-body">
                        ...
                        <p class="welcome-text mb-6">
                            Welcome to Numerica Academy's. Here, you can monitor your child's progress, review assignments, and stay informed about their learning journey.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-sm-5 text-center text-sm-left">
                    <div class="card-body pb-0 px-0 px-md-6">
                        <img src="../assets/img/illustrations/mm.webp"
                             height="150" class="scaleX-n1-rtl rounded-circle" alt="Dashboard Illustration" />
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <!-- Child Progress -->
    <!-- Loop through each child and display a card for their progress -->
    @foreach ($children as $child)
        <div class="col-12 col-md-4 mb-4">
            <a href="{{ route('parent.child.progress', ['childId' => $child->id]) }}" class="text-decoration-none">
                <div class="card dashboard-card h-100">
                    <div class="card-icon-container">
                        <img src="../assets/img/icons/unicons/pa.jpeg" alt="View Progress" class="card-icon">
                    </div>
                    <h5 class="dashboard-card-title">View {{ $child->name }}'s Progress</h5>
                </div>
            </a>
        </div>
    @endforeach
...
{{--    <!-- View Worksheets -->--}}
{{--    <div class="col-12 col-md-4 mb-4">--}}
{{--        <a href="{{ route('worksheet.worksheet_list') }}" class="text-decoration-none">--}}
{{--            <div class="card dashboard-card h-100">--}}
{{--                <div class="card-icon-container">--}}
{{--                    <img src="../assets/img/icons/unicons/worksheet-icon.jpeg" alt="View Worksheets" class="card-icon">--}}
{{--                </div>--}}
{{--                <h5 class="dashboard-card-title">Review Worksheets</h5>--}}
{{--            </div>--}}
{{--        </a>--}}
{{--    </div>--}}
...
{{--    <!-- View Notifications -->--}}
{{--    <div class="col-12 col-md-4 mb-4">--}}
{{--        <a href="{{ route('parent.notifications') }}" class="text-decoration-none">--}}
{{--            <div class="card dashboard-card h-100">--}}
{{--                <div class="card-icon-container">--}}
{{--                    <img src="../assets/img/icons/unicons/bell-icon.jpeg" alt="Notifications" class="card-icon">--}}
{{--                </div>--}}
{{--                <h5 class="dashboard-card-title">View Notifications</h5>--}}
{{--            </div>--}}
{{--        </a>--}}
{{--    </div>--}}
</div>
